...
/// <para>★ 背景（2026-08-14 事故，自 LockWord 承接）：AcquireShared 曾用 <b>OR 置位</b>而非 ADD 递增——
...
/// <para>★ 写偏向契约（2026-08-19 重构新增）：等待中的写者（pending）挡住<b>新读者</b>——
...
public class SpinRWLockTests
{
    ...
    // ════════════════════════════════════════════════════════════
    //  共享计数（★ OR 置位 bug 的回归测试族——2026-08-14 事故的直接产物）
    // ════════════════════════════════════════════════════════════
    ...
    // ════════════════════════════════════════════════════════════
    //  写偏向契约（★ 2026-08-19 重构新增——LockWord 读优先写饥饿的根治验证）
    // ════════════════════════════════════════════════════════════
    ...
    //   （2026-08-20 满套验证实录：SpinLockScope/MaintenanceGate 等预存测试被殃及）。
