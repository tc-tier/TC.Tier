...
internal sealed class GatedWriteFileSystem : IFileSystem
{
    ...
    public IEnumerable<FsEntry> EnumerateFiles(string? path = null, string pattern = "*", bool recursive = false) => _inner.EnumerateFiles(path, pattern, recursive);
    public IEnumerable<FsEntry> EnumerateDirectories(string? path = null, string pattern = "*", bool recursive = false) => _inner.EnumerateDirectories(path, pattern, recursive);
    public IEnumerable<FsEntry> EnumerateEntries(string? path = null, string pattern = "*", bool recursive = false) => _inner.EnumerateEntries(path, pattern, recursive);
