import{a}from"./chunk-HKAKSKF2.min.js";var i={},c={info:a(async()=>{let{createInfoServices:e}=await import("./info-DKCQHKI2-GZB5K6VX.min.js"),r=e().Info.parser.LangiumParser;i.info=r},"info"),packet:a(async()=>{let{createPacketServices:e}=await import("./packet-7NZHBO7P-2ZIQEONS.min.js"),r=e().Packet.parser.LangiumParser;i.packet=r},"packet"),pie:a(async()=>{let{createPieServices:e}=await import("./pie-RZYD4A2V-GR7E6XN7.min.js"),r=e().Pie.parser.LangiumParser;i.pie=r},"pie"),treeView:a(async()=>{let{createTreeViewServices:e}=await import("./treeView-QDETBFTQ-OY4KDGU6.min.js"),r=e().TreeView.parser.LangiumParser;i.treeView=r},"treeView"),architecture:a(async()=>{let{createArchitectureServices:e}=await import("./architecture-TIHT7OUA-YGIS454G.min.js"),r=e().Architecture.parser.LangiumParser;i.architecture=r},"architecture"),gitGraph:a(async()=>{let{createGitGraphServices:e}=await import("./gitGraph-TEB2WS4Q-HRL4L7JU.min.js"),r=e().GitGraph.parser.LangiumParser;i.gitGraph=r},"gitGraph"),eventmodeling:a(async()=>{let{createEventModelingServices:e}=await import("./eventmodeling-45OFAUF4-YI2S23ZA.min.js"),r=e().EventModel.parser.LangiumParser;i.eventmodeling=r},"eventmodeling"),radar:a(async()=>{let{createRadarServices:e}=await import("./radar-I7S5WNFK-5OD4X2Y5.min.js"),r=e().Radar.parser.LangiumParser;i.radar=r},"radar"),railroad:a(async()=>{let{createRailroadServices:e}=await import("./railroad-3IZDKUUU-6LYHPVY5.min.js"),r=e().Railroad.parser.LangiumParser;i.railroad=r},"railroad"),railroadEbnf:a(async()=>{let{createRailroadEbnfServices:e}=await import("./railroad-ebnf-EBAXGLYW-LFX7I3CD.min.js"),r=e().RailroadEbnf.parser.LangiumParser;i.railroadEbnf=r},"railroadEbnf"),railroadAbnf:a(async()=>{let{createRailroadAbnfServices:e}=await import("./railroad-abnf-AHOZXSZD-LOXFCB6C.min.js"),r=e().RailroadAbnf.parser.LangiumParser;i.railroadAbnf=r},"railroadAbnf"),railroadPeg:a(async()=>{let{createRailroadPegServices:e}=await import("./railroad-peg-LSFZ7HO6-XIKVWYFY.min.js"),r=e().RailroadPeg.parser.LangiumParser;i.railroadPeg=r},"railroadPeg"),treemap:a(async()=>{let{createTreemapServices:e}=await import("./treemap-6X3UGDF4-EWE3GS47.min.js"),r=e().Treemap.parser.LangiumParser;i.treemap=r},"treemap"),wardley:a(async()=>{let{createWardleyServices:e}=await import("./wardley-OPB4EBWU-7K2JTHUS.min.js"),r=e().Wardley.parser.LangiumParser;i.wardley=r},"wardley"),cynefin:a(async()=>{let{createCynefinServices:e}=await import("./cynefin-VYW2F7L2-OPXKOKHX.min.js"),r=e().Cynefin.parser.LangiumParser;i.cynefin=r},"cynefin")};async function d(e,r){let n=c[e];if(!n)throw new Error(`Unknown diagram type: ${e}`);i[e]||await n();let t=i[e].parse(r);if(t.lexerErrors.length>0||t.parserErrors.length>0)throw new l(t);return t.value}a(d,"parse");var l=class extends Error{constructor(e){let r=e.lexerErrors.map(o=>{let t=o.line!==void 0&&!isNaN(o.line)?o.line:"?",s=o.column!==void 0&&!isNaN(o.column)?o.column:"?";return`Lexer error on line ${t}, column ${s}: ${o.message}`}).join(`
...
//# sourceMappingURL=chunk-LH7OGZFQ.min.js.map
...
// SIG // dbImnOz3lKYjVeeKJmjB8HM5ZkrkCInaGK2rYGRRb3Kg
...
// SIG // BgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiB