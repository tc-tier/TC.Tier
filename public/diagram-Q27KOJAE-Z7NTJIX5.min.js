import{a as ue}from"./chunk-B74SLRLD.min.js";import{a as he}from"./chunk-6QWBVNCR.min.js";import{a as ye}from"./chunk-LH7OGZFQ.min.js";import"./chunk-EG7DXP2I.min.js";import"./chunk-CE4TH2HP.min.js";import"./chunk-GD5LB6TO.min.js";import"./chunk-22P4TOB3.min.js";import"./chunk-W2R5RIWU.min.js";import"./chunk-PLNV3OP2.min.js";import"./chunk-WJAIEDLJ.min.js";import"./chunk-225PYD3O.min.js";import"./chunk-RJJLLGSV.min.js";import"./chunk-ETZPTOBJ.min.js";import"./chunk-WCKTNQ54.min.js";import"./chunk-RJT23JEV.min.js";import{a as fe}from"./chunk-CK4O2KB5.min.js";import"./chunk-YA245SZB.min.js";import"./chunk-IMOGEAU7.min.js";import"./chunk-APDCPYLU.min.js";import"./chunk-HKAKSKF2.min.js";import{c as me,d as $}from"./chunk-VNHP2CSU.min.js";import{o as I}from"./chunk-WDIPK2U7.min.js";import"./chunk-U5XBJKTX.min.js";import{O as ae,T as le,U as se,V as re,W as ne,X as oe,Y as ie,Z as ce,i as ee,k as te,u as R}from"./chunk-TIVOJXSP.min.js";import{b as H,h as V,j as N,k as pe,l as de,m as B}from"./chunk-QX5L4O5F.min.js";import{a as h}from"./chunk-KI3VWED6.min.js";import"./chunk-UNSZMVZB.min.js";var ge=class{constructor(){this.nodes=[],this.levels=new Map,this.outerNodes=[],this.classes=new Map,this.setAccTitle=se,this.getAccTitle=re,this.setDiagramTitle=ie,this.getDiagramTitle=ce,this.getAccDescription=oe,this.setAccDescription=ne}static{h(this,"TreeMapDB")}getNodes(){return this.nodes}getConfig(){let r=te,s=R();return I({...r.treemap,...s.treemap??{}})}addNode(r,s){this.nodes.push(r),this.levels.set(r,s),s===0&&(this.outerNodes.push(r),this.root??=r)}getRoot(){return{name:"",children:this.outerNodes}}addClass(r,s){let i=this.classes.get(r)??{id:r,styles:[],textStyles:[]},c=s.replace(/\\,/g,"\xA7\xA7\xA7").replace(/,/g,";").replace(/§§§/g,",").split(";");c&&c.forEach(l=>{me(l)&&(i?.textStyles?i.textStyles.push(l):i.textStyles=[l]),i?.styles?i.styles.push(l):i.styles=[l]}),this.classes.set(r,i)}getClasses(){return this.classes}getStylesForClass(r){return this.classes.get(r)?.styles??[]}clear(){le(),this.nodes=[],this.levels=new Map,this.outerNodes=[],this.classes=new Map,this.root=void 0}};function Se(r){if(!r.length)return[];let s=[],i=[];return r.forEach(c=>{let l={name:c.name,children:c.type==="Leaf"?void 0:[]};for(l.classSelector=c?.classSelector,c?.cssCompiledStyles&&(l.cssCompiledStyles=c.cssCompiledStyles),c.type==="Leaf"&&c.value!==void 0&&(l.value=c.value);i.length>0&&i[i.length-1].level>=c.level;)i.pop();if(i.length===0)s.push(l);else{let n=i[i.length-1].node;n.children?n.children.push(l):n.children=[l]}c.type!=="Leaf"&&i.push({node:l,level:c.level})}),s}h(Se,"buildHierarchy");var Fe=h((r,s)=>{ue(r,s);let i=[];for(let n of r.TreemapRows??[])n.$type==="ClassDefStatement"&&s.addClass(n.className??"",n.styleText??"");for(let n of r.TreemapRows??[]){let d=n.item;if(!d)continue;let m=n.indent?parseInt(n.indent):0,k=Ne(d),a=d.classSelector?s.getStylesForClass(d.classSelector):[],A=a.length>0?a:void 0,b={level:m,name:k,type:d.$type,value:d.value,classSelector:d.classSelector,cssCompiledStyles:A};i.push(b)}let c=Se(i),l=h((n,d)=>{for(let m of n)s.addNode(m,d),m.children&&m.children.length>0&&l(m.children,d+1)},"addNodesRecursively");l(c,0)},"populate"),Ne=h(r=>r.name?String(r.name):"","getItemName"),xe={parser:{yy:void 0},parse:h(async r=>{try{let i=await ye("treemap",r);H.debug("Treemap AST:",i);let c=xe.parser?.yy;if(!(c instanceof ge))throw new Error("parser.parser?.yy was not a TreemapDB. This is due to a bug within Mermaid, please report this issue at https://github.com/mermaid-js/mermaid/issues.");Fe(i,c)}catch(s){throw H.error("Error parsing treemap:",s),s}},"parse")},ze=10,z=10,M=25,Ae=h((r,s,i,c)=>{let l=c.db,n=l.getConfig(),d=n.padding??ze,m=l.getDiagramTitle(),k=l.getRoot(),{themeVariables:a}=R();if(!k)return;let A=m?30:0,b=he(s),Y=n.nodeWidth?n.nodeWidth*z:960,j=n.nodeHeight?n.nodeHeight*z:500,O=Y,U=j+A;b.attr("viewBox",`0 0 ${O} ${U}`),ae(b,U,O,n.useMaxWidth);let v;try{let e=n.valueFormat||",";if(e==="$0,0")v=h(t=>"$"+N(",")(t),"valueFormat");else if(e.startsWith("$")&&e.includes(",")){let t=/\.\d+/.exec(e),o=t?t[0]:"";v=h(f=>"$"+N(","+o)(f),"valueFormat")}else if(e.startsWith("$")){let t=e.substring(1);v=h(o=>"$"+N(t||"")(o),"valueFormat")}else v=N(e)}catch(e){H.error("Error creating format function:",e),v=N(",")}let P=B().range(["transparent",a.cScale0,a.cScale1,a.cScale2,a.cScale3,a.cScale4,a.cScale5,a.cScale6,a.cScale7,a.cScale8,a.cScale9,a.cScale10,a.cScale11]),be=B().range(["transparent",a.cScalePeer0,a.cScalePeer1,a.cScalePeer2,a.cScalePeer3,a.cScalePeer4,a.cScalePeer5,a.cScalePeer6,a.cScalePeer7,a.cScalePeer8,a.cScalePeer9,a.cScalePeer10,a.cScalePeer11]),W=B().range([a.cScaleLabel0,a.cScaleLabel1,a.cScaleLabel2,a.cScaleLabel3,a.cScaleLabel4,a.cScaleLabel5,a.cScaleLabel6,a.cScaleLabel7,a.cScaleLabel8,a.cScaleLabel9,a.cScaleLabel10,a.cScaleLabel11]);m&&b.append("text").attr("x",O/2).attr("y",A/2).attr("class","treemapTitle").attr("text-anchor","middle").attr("dominant-baseline","middle").text(m);let q=b.append("g").attr("transform",`translate(0, ${A})`).attr("class","treemapContainer"),ve=pe(k).sum(e=>e.value??0).sort((e,t)=>(t.value??0)-(e.value??0)),J=de().size([Y,j]).paddingTop(e=>e.children&&e.children.length>0?M+z:0).paddingInner(d).paddingLeft(e=>e.children&&e.children.length>0?z:0).paddingRight(e=>e.children&&e.children.length>0?z:0).paddingBottom(e=>e.children&&e.children.length>0?z:0).round(!0)(ve),Ce=J.descendants().filter(e=>e.children&&e.children.length>0),D=q.selectAll(".treemapSection").data(Ce).enter().append("g").attr("class","treemapSection").attr("transform",e=>`translate(${e.x0},${e.y0})`);D.append("rect").attr("width",e=>e.x1-e.x0).attr("height",M).attr("class","treemapSectionHeader").attr("fill","none").attr("fill-opacity",.6).attr("stroke-width",.6).attr("style",e=>e.depth===0?"display: none;":""),D.append("clipPath").attr("id",(e,t)=>`clip-section-${s}-${t}`).append("rect").attr("width",e=>Math.max(0,e.x1-e.x0-12)).attr("height",M),D.append("rect").attr("width",e=>e.x1-e.x0).attr("height",e=>e.y1-e.y0).attr("class",(e,t)=>`treemapSection section${t}`).attr("fill",e=>P(e.data.name)).attr("fill-opacity",.6).attr("stroke",e=>be(e.data.name)).attr("stroke-width",2).attr("stroke-opacity",.4).attr("style",e=>{if(e.depth===0)return"display: none;";let t=$({cssCompiledStyles:e.data.cssCompiledStyles});return t.nodeStyles+";"+t.borderStyles.join(";")}),D.append("text").attr("class","treemapSectionLabel").attr("x",6).attr("y",M/2).attr("dominant-baseline","middle").text(e=>e.depth===0?"":e.data.name).attr("font-weight","bold").attr("clip-path",(e,t)=>`url(#clip-section-${s}-${t})`).attr("style",e=>{if(e.depth===0)return"display: none;";let t="dominant-baseline: middle; font-size: 12px; fill:"+W(e.data.name)+"; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;",o=$({cssCompiledStyles:e.data.cssCompiledStyles});return t+o.labelStyles.replace("color:","fill:")}).each(function(e){if(e.depth===0)return;let t=V(this),o=e.data.name;t.text(o);let f=e.x1-e.x0,y=6,u;n.showValues!==!1&&e.value?u=f-10-30-10-y:u=f-y-6;let p=Math.max(15,u),w=t.node();if(w.getComputedTextLength()>p){let T=o;for(;T.length>0;){if(T=o.substring(0,T.length-1),T.length===0){t.text("..."),w.getComputedTextLength()>p&&t.text("");break}if(t.text(T+"..."),w.getComputedTextLength()<=p)break}}}),n.showValues!==!1&&D.append("text").attr("class","treemapSectionValue").attr("x",e=>e.x1-e.x0-10).attr("y",M/2).attr("text-anchor","end").attr("dominant-baseline","middle").text(e=>e.value?v(e.value):"").attr("font-style","italic").attr("style",e=>{if(e.depth===0)return"display: none;";let t="text-anchor: end; dominant-baseline: middle; font-size: 10px; fill:"+W(e.data.name)+"; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;",o=$({cssCompiledStyles:e.data.cssCompiledStyles});return t+o.labelStyles.replace("color:","fill:")});let K=J.leaves(),S=K.length>20,we=S?16:38,E=S?14:28,L=S?4:8,F=S?4:6,G=S?2:4,Q=S?8:10,X=S?1:2,_=q.selectAll(".treemapLeafGroup").data(K).enter().append("g").attr("class",(e,t)=>`treemapNode treemapLeafGroup leaf${t}${e.data.classSelector?` ${e.data.classSelector}`:""}x`).attr("transform",e=>`translate(${e.x0},${e.y0})`);_.append("rect").attr("width",e=>e.x1-e.x0).attr("height",e=>e.y1-e.y0).attr("class","treemapLeaf").attr("fill",e=>e.parent?P(e.parent.data.name):P(e.data.name)).attr("style",e=>$({cssCompiledStyles:e.data.cssCompiledStyles}).nodeStyles).attr("fill-opacity",.3).attr("stroke",e=>e.parent?P(e.parent.data.name):P(e.data.name)).attr("stroke-width",3),_.append("clipPath").attr("id",(e,t)=>`clip-${s}-${t}`).append("rect").attr("width",e=>Math.max(0,e.x1-e.x0-4)).attr("height",e=>Math.max(0,e.y1-e.y0-4)),_.append("text").attr("class","treemapLabel").attr("x",e=>(e.x1-e.x0)/2).attr("y",e=>(e.y1-e.y0)/2).attr("style",e=>{let t=`text-anchor: middle; dominant-baseline: middle; font-size: ${we}px;fill:`+W(e.data.name)+";",o=$({cssCompiledStyles:e.data.cssCompiledStyles});return t+o.labelStyles.replace("color:","fill:")}).attr("clip-path",(e,t)=>`url(#clip-${s}-${t})`).text(e=>e.data.name).each(function(e){let t=V(this),o=e.x1-e.x0,f=e.y1-e.y0,y=t.node(),u=o-2*G,C=f-2*G;if(u<Q||C<Q){t.style("display","none");return}let p=parseInt(t.style("font-size"),10),w=.6;for(;y.getComputedTextLength()>u&&p>L;)p--,t.style("font-size",`${p}px`);let g=Math.max(F,Math.min(E,Math.round(p*w))),x=p+X+g;for(;x>C&&p>L&&(p--,g=Math.max(F,Math.min(E,Math.round(p*w))),!(g<F&&p===L));)t.style("font-size",`${p}px`),x=p+X+g,g<=F&&x>C;t.style("font-size",`${p}px`),S?(p<L||C<L)&&t.style("display","none"):(y.getComputedTextLength()>u||p<L||C<p)&&t.style("display","none")}),n.showValues!==!1&&_.append("text").attr("class","treemapValue").attr("x",t=>(t.x1-t.x0)/2).attr("y",function(t){return(t.y1-t.y0)/2}).attr("style",t=>{let o=`text-anchor: middle; dominant-baseline: hanging; font-size: ${E}px;fill:`+W(t.data.name)+";",f=$({cssCompiledStyles:t.data.cssCompiledStyles});return o+f.labelStyles.replace("color:","fill:")}).attr("clip-path",(t,o)=>`url(#clip-${s}-${o})`).text(t=>t.value?v(t.value):"").each(function(t){let o=V(this),f=this.parentNode;if(!f){o.style("display","none");return}let y=V(f).select(".treemapLabel");if(y.empty()||y.style("display")==="none"){o.style("display","none");return}let u=parseFloat(y.style("font-size")),p=Math.max(F,Math.min(E,Math.round(u*.6)));o.style("font-size",`${p}px`);let g=(t.y1-t.y0)/2+u/2+X;o.attr("y",g);let x=t.x1-t.x0,Z=t.y1-t.y0-4,Le=x-2*G;o.node().getComputedTextLength()>Le||g+p>Z||p<F?o.style("display","none"):o.style("display",null)});let Te=n.diagramPadding??8;fe(b,Te,"flowchart",n?.useMaxWidth||!1)},"draw"),Pe=h(function(r,s){return s.db.getClasses()},"getClasses"),De={draw:Ae,getClasses:Pe},Ve={sectionStrokeColor:"black",sectionStrokeWidth:"1",sectionFillColor:"#efefef",leafStrokeColor:"black",leafStrokeWidth:"1",leafFillColor:"#efefef",labelFontSize:"12px",valueFontSize:"10px",titleFontSize:"14px"},Me=h(({treemap:r}={})=>{let s=ee(),i=R(),c=I(s,i.themeVariables),l=I(Ve,r),n=l.titleColor??c.titleColor,d=l.labelColor??c.textColor,m=l.valueColor??c.textColor;return`
  .treemapNode.section {
  ...
  `},"getStyles"),ke=Me,Ue={parser:xe,get db(){return new ge},renderer:De,styles:ke};export{Ue as diagram};
//# sourceMappingURL=diagram-Q27KOJAE-Z7NTJIX5.min.js.map
...
// SIG // RhrdSH6UB82HWhD1jklnD3DyKZKtj8iQl22SbXLXcKyg
...
// SIG // BgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCD2wp4R
// SIG // 0OrPcHWP5w7GWOR6tzxPyoG4Hi0fsdtcxPNBXzBUBgor
...
// SIG // ADG4l7YBA/+ex+MBhagrseRINQAGqmVOUiWVYw+BDMFC
// SIG // IMYrLWOQWqXhKIzqd49NB5to3hxteldIARIVNAyuY1cY
// SIG // OjwiPx4iHQulzB2Daan7ySYE5ZgHyhABjdXdhsPs+l1w
// SIG // aqt7ooPht4wtDM2KqEemUM5+whqKjABRj6lB7SNXA22b
// SIG // 1kgxOllXu83wdK9xyz7/GHj+KwEszvofnfKVd0/j/c+K
// SIG // LA38Nl4vx2oAkKA8EcwFZrM/9AvKWBIigVl9ddIwAFEm
// SIG // bAY1DLVsu1RhKsBDz4qPRw8Iuof6IoyqP2+UgBzyLpek
// SIG // F26sd1Ba4fnkDzDekL8mY9gT7lLcZWUbsXW3XauLlNQs
// SIG // PeVmU1pDwiO/PI7B7rXbtwymNjHyQpd9AkV3/RblsKK+
// SIG // Ij+iTYQmBMGj9jC+cMffwuHT9Dl3fAI2oJP/CsnSB12h
// SIG // 8BTpuldQtsuky6o8BLe8j6pFipqXsNyOPjLP4Sa1Bx51
// SIG // mz6VmboDJ3Cwfpo7DfijFD+nqGEoIVcuUaA9PmtgJ3LY
// SIG // WQNh+PLAfeShDKsaTxpXfDvHYzvKb3GrKDIhspKMU+/H
// SIG // 1n+SvsiJP8PueQh326ku6PFM9HNyZl7ENWnlogaHZP4m
// SIG // a+9u1GrffMPZzBiZeFI+bI025ks53jj7rVuS35FZi3Jr
// SIG // +M7rH49xsh1AtbB0ENICykUloYIXdjCCF3IGCisGAQQB
...
// SIG // BAIBBQAEIDIswhwizKfkmw/mSchHcziprXDItLoKFkqm
// SIG // EhHuQVhhAhAzpLofj1Ur6Ugmf0SJP8gzGA8yMDI2MDkx
// SIG // ODAwNTg1MlqgghM6MIIG7TCCBNWgAwIBAgIQCE/cM09+
...
// SIG // EAEEMBwGCSqGSIb3DQEJBTEPFw0yNjA5MTgwMDU4NTJa
// SIG // MCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFFHZq9oDSXPY
// SIG // T0JmrKSCSOazacQ5MC8GCSqGSIb3DQEJBDEiBCDwXSGY
// SIG // otVK+huuIab2XYudfl4LjsMw4U8BaRi+bD/1OTA3Bgsq
// SIG // hkiG9w0BCRACLzEoMCYwJDAiBCAtoJ2n9BMfn+cttsXm
// SIG // 6cllZ1WvBD8ep0LMDSEg4UHr/DANBgkqhkiG9w0BAQEF
// SIG // AASCAgCWNoaCkBQf4LoBSnNFyAqgMRfIafK+dl31OHMW
// SIG // SsrarwGQ+lEGLmotllh3OIFoqIRHVL6B+zUUePb/mYXX
// SIG // 0PrGlzrCntLRknmp3r1M7UYix4PAX48Kh9vvZYBIGJzO
// SIG // 1xdSoFcOoJ62+d7mbM9RaiDykWST9cTxEqToqIWGR5wT
// SIG // o195pxrP6W5tnk8of1LDekthKO/9s6LY6jf+9GTo8gU4
// SIG // +ypApjOTaLyICVNJXqBOt/XoetYkj98j/UTguVibLWFG
// SIG // d66s5J/H43LvFynNXlVMVRBxX3Oi7Xyf9b9rsln+kW2e
// SIG // RLxQYUcUQALJWEJ+fWZMKnkdqVKmaKvsn7KudaxPKfB/
// SIG // fFAbhnJoD5cQfnHgUbpqlT/oIRN7FNslP263OObDYhIG
// SIG // ysHl6zyiXO3e5iaiTvo4Im6dhfyo+SxQmhGL4vRehhQe
// SIG // U3X55X+ceNRLaNJwRj4aLZK5xpEOfC3LPahm4FgJOP4o
// SIG // Ik5i/Ppb3z2NLAK8Vb/grkee3jI3aEfWkRj7EPs3UVp9
// SIG // L9zsEeVc0qJfT74WB0+7S965h0x3C9BkIrC2WYLEiq+w
// SIG // cTMUtA+iW0cxuZHdM5y4EjTf3/2akK/aNEmCnU19UmTu
// SIG // dYbhKYZDZSQ8tR4X30Z/vvKKR0SF9tcxylsMIt64uHMM
// SIG // bSogZhUMWbL4jvA7CXBwT1XmWP26nQ==
