// ══ 移植自 dotnet/runtime System.IO.Hashing (Crc64.Vectorized.cs, v8.0.0, MIT)——自研化收编，PCLMULQDQ/ARM AES 向量折叠原样。
...
using static TC.Tier.Core.Primitives.VectorHelper;

namespace TC.Tier.Core.Primitives
{
    /// <summary><see cref="UnifiedCrc64"/> 的向量化部分——PCLMULQDQ / ARM AES 折叠路径（官方同源）。</summary>
