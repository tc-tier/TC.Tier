// ══ 移植自 dotnet/runtime System.IO.Hashing (XxHashShared.cs, v8.0.0, MIT)——自研化收编：算法/字节序/性能与官方逐位一致。下行为原版权头（MIT 要求保留）。
...
{
    /// <summary>XXH3 家族共享实现（本仓库仅用其 XxHash128 一次性/长输入路径）。</summary>
